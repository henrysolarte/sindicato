...
export default function RegistroUsuario() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://sindicato-w3ev.onrender.com/api/usuarios/registro', {
        method: 'POST',
        headers: {
              ...
              <div className="col-lg-6">
                <div className="bg-white rounded shadow-sm p-5">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                      <label className="form-label" style={{ color: '#046a4f', fontWeight: '600' }}>Nombre Completo</label>
                      <input
                        type="text"
                    ...
                    <div className="mb-3">
                      <label className="form-label" style={{ color: '#046a4f', fontWeight: '600' }}>Confirmar Contraseña</label>
                      <input
                        type="password"
                        className="form-control"
                  ...
                  <p className="text-center mt-3" style={{ color: '#666' }}>
                    ¿Ya tienes cuenta? <a href="/index.html" style={{ color: '#046a4f', textDecoration: 'none', fontWeight: 'bold' }}>Volver al inicio</a>
                  </p>
                </div>
              </div>
            </div>
